...
//        'datetime' => App\Forms\Fields\Datetime::class
        'imagepreview' => App\Http\Forms\Fields\ImagePreviewType::class,
        'filepreview' => App\Http\Forms\Fields\FilePreviewType::class,
        'optional_checkbox' => App\Http\Forms\Fields\OptionalCheckboxType::class,
        'vue-multiselect' => App\Http\Forms\Fields\VueComponents\MultiSelectType::class,
    ]
];
